...
else
{
	...
	{
		?>
		<form id="frm_system_status" class="layout-form wplb-page-width" method="post" style="max-width:1000px;">
				...
				?>
					<div class="widget-layout">
						<div class="widget-layout-title">
							<h4>
								<?php _e("System Status", map_bank); ?>
							</h4>
						</div>
						<div class="widget-layout-body">
							<a class="btn btn-danger system-report" href="#"><?php _e("Get System Report", map_bank); ?></a>
							<div id="wp-map-bank-system-report" class="layout-system-report">
								<textarea readonly="readonly"></textarea>
							</div>
							<a class="btn btn-danger close-report" href="#"><?php _e("Close System Report", map_bank); ?></a>
							<div class="separator-doubled"></div>
							<div class="fluid-layout">
								<div class="layout-span6 responsive">
									<div class="widget-layout">
										<div class="widget-layout-title">
											<h4><?php _e("Environment", map_bank); ?></h4>
										</div>
										<div class="widget-layout-body">
											<div class="fluid-layout">
												<div class="layout-span12 responsive">
													<div class="layout-control-group">
														<label class="layout-control-label"><?php _e("Home URL", map_bank); ?>:</label>
														<div class="layout-controls wp-map-custom-layout-control">
											...
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("Site URL :", map_bank); ?></label>
												<div class="layout-controls wp-map-custom-layout-control">
													<span><?php echo site_url(); ?></span>
												</div>
											</div>
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("WP Version :", map_bank); ?></label>
												<div class="layout-controls wp-map-custom-layout-control">
													<span><?php bloginfo("version"); ?></span>
												</div>
											</div>
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("WP Multisite Enabled :", map_bank); ?></label>
												<div class="layout-controls wp-map-custom-layout-control">
													<span><?php if (is_multisite()) echo "Yes"; else echo "No"; ?></span>
												</div>
											</div>
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("Web Server Info :", map_bank); ?></label>
												<div class="layout-controls wp-map-custom-layout-control">
													<span><?php echo esc_html($_SERVER["SERVER_SOFTWARE"]); ?></span>
												</div>
											</div>
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("PHP Version :", map_bank); ?></label>
												<div class="layout-controls wp-map-custom-layout-control">
													<span><?php if (function_exists("phpversion")) echo esc_html(phpversion()); ?></span>
												</div>
											</div>
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("MySQL Version :", map_bank); ?></label>
												<div class="layout-controls wp-map-custom-layout-control">
													<span>
													<?php 
														global $wpdb;
											...
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("WP Debug Mode :", map_bank); ?></label>
												<div class="layout-controls wp-map-custom-layout-control">
													<span><?php if (defined("WP_DEBUG") && WP_DEBUG) echo "Yes"; else echo "No"; ?></span>
												</div>
											</div>
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("WP Language :", map_bank); ?></label>
												<div class="layout-controls wp-map-custom-layout-control">
													<span><?php if (defined("WPLANG") && WPLANG) echo WPLANG; else _e("Default"); ?></span>
												</div>
											</div>
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("PHP Post Max Size :", map_bank); ?></label>
												<div class="layout-controls wp-map-custom-layout-control">
													<span>
													<?php 
											...
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("WP Max Upload Size :", map_bank); ?></label>
												<div class="layout-controls wp-map-custom-layout-control">
										...
										?>
											<div class="layout-control-group">
												...
												<div class="layout-controls wp-map-custom-layout-control">
													...
													{
														echo _e("Success", map_bank);
													}
													else
													{
														echo _e("Failed", map_bank);
													}
														 ?></span>
												</div>
											</div>
										<?php if (function_exists("ini_get")) : ?>
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("PHP Max Script Execute Time", map_bank); ?> :</label>
												<div class="layout-controls wp-map-custom-layout-control">
													<span><?php echo ini_get("max_execution_time"); ?>s</span>
												</div>
											</div>
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("PHP Max Input Vars :", map_bank); ?></label>
												<div class="layout-controls wp-map-custom-layout-control">
													<span><?php echo ini_get("max_input_vars"); ?></span>
												</div>
											</div>
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("SUHOSIN Installed :", map_bank); ?></label>
												<div class="layout-controls wp-map-custom-layout-control">
										...
										<?php endif; ?>
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("Default Timezone :", map_bank); ?></label>
												<div class="layout-controls wp-map-custom-layout-control">
													<span>
														<?php
										...
										?>
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("Operating System :", map_bank); ?></label>
												<div class="layout-controls wp-map-custom-layout-control">
													<span>
											...
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("Memory usage :", map_bank); ?></label>
												<div class="layout-controls wp-map-custom-layout-control">
													<span>
											...
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("SQL Mode :", map_bank); ?></label>
												<div class="layout-controls wp-map-custom-layout-control">
													<span>
														<?php echo $sqlmode; ?>
													</span>
											...
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("PHP Safe Mode :", map_bank); ?></label>
												<div class="layout-controls wp-map-custom-layout-control">
													<span>
											...
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("PHP Allow URL fopen :", map_bank); ?></label>
												<div class="layout-controls wp-map-custom-layout-control">
													<span>
											...
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("PHP Memory Limit :", map_bank); ?></label>
												<div class="layout-controls wp-map-custom-layout-control">
													<span>
											...
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("PHP Max Post Size :", map_bank); ?></label>
												<div class="layout-controls wp-map-custom-layout-control">
													<span>
											...
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("PCRE Backtracking Limit :", map_bank); ?></label>
												<div class="layout-controls wp-map-custom-layout-control">
													<span>
											...
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("PHP Exif support :", map_bank); ?></label>
												<div class="layout-controls wp-map-custom-layout-control">
													<span>
														<?php echo $exif; ?>
													</span>
											...
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("PHP IPTC support :", map_bank); ?></label>
												<div class="layout-controls wp-map-custom-layout-control">
													<span>
														<?php echo $iptc; ?>
													</span>
											...
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("PHP XML support :", map_bank); ?></label>
												<div class="layout-controls wp-map-custom-layout-control">
													<span>
														<?php echo $xml; ?>
													</span>
								...
								<div class="layout-span6 responsive">
									<div class="widget-layout">
										...
										<div class="widget-layout-body">
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("Installed Plugins :", map_bank); ?></label>
												<div class="layout-controls wp-map-custom-layout-control">
													<span>
														<?php
									...
									<div class="widget-layout">
										...
										<div class="widget-layout-body">
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("Theme Name :", map_bank); ?></label>
												<div class="layout-controls wp-map-custom-layout-control">
													<span><?php echo $active_theme->Name; ?></span>
												</div>
											</div>
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("Theme Version :", map_bank); ?></label>
													<div class="layout-controls wp-map-custom-layout-control">
													<span><?php
											...
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("Author URL :", map_bank); ?></label>
												<div class="layout-controls wp-map-custom-layout-control">
		...
		<script type="text/javascript">
				...
				jQuery("a.system-report").click(function () {
					...
					try {
						jQuery("#wp-map-bank-system-report").slideDown();
						jQuery("#wp-map-bank-system-report textarea").val(report).focus().select();
						jQuery(this).fadeOut();
