													...
													<div class="layout-control-group">
														...
														<div class="layout-controls custom-layout-controls-maps">
															<select id="ux_ddl_map_language" class="layout-span12" name="ux_ddl_map_language" onchange="map_themes();">
																...
																<option value="en-nz"><?php _e("English (New Zealand)", map_bank); ?></option>
																<option value="en-ph"><?php _e("English (Phillipines)", map_bank); ?></option>
																<option value="en-za"><?php _e("English (South Africa)", map_bank); ?></option>
																<option value="en-tt"><?php _e("English (Trinidad)", map_bank); ?></option>
																...
																<option value="en-zw"><?php _e("English (Zimbabwe)", map_bank); ?></option>
																...
																<option value="fr-be"><?php _e("French (Belgium)", map_bank); ?></option>
																<option value="fr-ca"><?php _e("French (Canada)", map_bank); ?></option>
																<option value="fr-fr"><?php _e("French (France)", map_bank); ?></option>
																<option value="fr-lu"><?php _e("French (Luxembourg)", map_bank); ?></option>
																<option value="fr-mc"><?php _e("French (Monaco)", map_bank); ?></option>
																<option value="fr-ch"><?php _e("French (Switzerland)", map_bank); ?></option>
																...
																<option value="de-at"><?php _e("German (Austria)", map_bank); ?></option>
																<option value="de-de"><?php _e("German (Germany)", map_bank); ?></option>
																<option value="de-li"><?php _e("German (Liechtenstein)", map_bank); ?></option>
																<option value="de-lu"><?php _e("German (Luxembourg)", map_bank); ?></option>
																<option value="de-ch"><?php _e("German (Switzerland)", map_bank); ?></option>
																...
																<option value="it-it"><?php _e("Italian (Italy)", map_bank); ?></option>
																<option value="it-ch"><?php _e("Italian (Switzerland)", map_bank); ?></option>
																<option value="ja"><?php _e("Japanese", map_bank); ?></option>
																<option value="ko"><?php _e("Korean", map_bank); ?></option>
																<option value="mk"><?php _e("Macedonian", map_bank); ?></option>
																<option value="no"><?php _e("Norwegian", map_bank); ?></option>
																<option value="pl"><?php _e("Polish", map_bank); ?></option>
																<option value="pt"><?php _e("Portuguese", map_bank); ?></option>
																<option value="pt-br"><?php _e("Portuguese (Brazil)", map_bank); ?></option>
																<option value="pt-pt"><?php _e("Portuguese (Portugal)", map_bank); ?></option>
																<option value="ro"><?php _e("Romanian", map_bank); ?></option>
																<option value="ro-mo"><?php _e("Romanian (Moldova)", map_bank); ?></option>
																<option value="ro-ro"><?php _e("Romanian (Romania)", map_bank); ?></option>
																<option value="ru"><?php _e("Russian", map_bank); ?></option>
																<option value="ru-mo"><?php _e("Russian (Moldova)", map_bank); ?></option>
																<option value="ru-ru"><?php _e("Russian (Russia)", map_bank); ?></option>
																...
																<option value="es-ar"><?php _e("Spanish (Argentina)", map_bank); ?></option>
																<option value="es-bo"><?php _e("Spanish (Bolivia)", map_bank); ?></option>
																<option value="es-cl"><?php _e("Spanish (Chile)", map_bank); ?></option>
																<option value="es-co"><?php _e("Spanish (Colombia)", map_bank); ?></option>
																<option value="es-cr"><?php _e("Spanish (Costa Rica)", map_bank); ?></option>
																<option value="es-do"><?php _e("Spanish (Dominican Republic)", map_bank); ?></option>
																<option value="es-ec"><?php _e("Spanish (Ecuador)", map_bank); ?></option>
																<option value="es-sv"><?php _e("Spanish (El Salvador)", map_bank); ?></option>
																<option value="es-gt"><?php _e("Spanish (Guatemala)", map_bank); ?></option>
																<option value="es-hn"><?php _e("Spanish (Honduras)", map_bank); ?></option>
																<option value="es-mx"><?php _e("Spanish (Mexico)", map_bank); ?></option>
																<option value="es-ni"><?php _e("Spanish (Nicaragua)", map_bank); ?></option>
																<option value="es-pa"><?php _e("Spanish (Panama)", map_bank); ?></option>
																<option value="es-py"><?php _e("Spanish (Paraguay)", map_bank); ?></option>
																<option value="es-pe"><?php _e("Spanish (Peru)", map_bank); ?></option>
																<option value="es-pr"><?php _e("Spanish (Puerto Rico)", map_bank); ?></option>
																<option value="es-es"><?php _e("Spanish (Spain)", map_bank); ?></option>
																<option value="es-uy"><?php _e("Spanish (Uruguay)", map_bank); ?></option>
																<option value="es-ve"><?php _e("Spanish (Venezuela)", map_bank); ?></option>
																<option value="sv"><?php _e("Swedish", map_bank); ?></option>  
																<option value="sv-fi"><?php _e("Swedish (Finland)", map_bank); ?></option>
																<option value="sv-se"><?php _e("Swedish (Sweden)", map_bank); ?></option>
																<option value="tr"><?php _e("Turkish", map_bank); ?></option>
																<option value="th"><?php _e("Thai", map_bank); ?></option>
